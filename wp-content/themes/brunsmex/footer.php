<footer>
    <div class="text-center footer-rights">
        <p>
            Derechos reservados BRUNSMEX S.A. DE C.V. <?php echo date('Y'); ?> | Aviso de privacidad | Design by: <a href="http://mixen.mx"><img src="http://mixen.mx/firma/logo-mixen.png" alt="Agencia Mixen"> mixen.mx</a>
        </p>
    </div>
</footer>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
